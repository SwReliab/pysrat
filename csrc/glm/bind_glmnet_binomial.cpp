...
static GLMBinomialENetResult glmnet_binomial_identity_py(
  ...
  return glmnet_binomial_identity(
      ...
      alpha, lambda, penalty_factor_e,
      max_iter, tol, link, eps_mu, eps_dmu);
}

static GLMBinomialENetResult glmnet_binomial_correlated_py(
    py::array_t<double, py::array::c_style | py::array::forcecast> X,
    py::array_t<double, py::array::c_style | py::array::forcecast> y,
    py::array_t<double, py::array::c_style | py::array::forcecast> n_trials,
    py::array_t<double, py::array::c_style | py::array::forcecast> offset,
  ...
  return glmnet_binomial_correlated(
      X_e, y_e, n_e, off_e,
      fit_intercept, intercept0, b0_e, stdmask,
      lambda_l2_mat_e, alpha, lambda, penalty_factor_e,
      max_iter, tol, link, eps_mu, eps_dmu);
}
...
void bind_glmnet_binomial(py::module_& m) {
  ...
  m.def("glmnet_binomial_identity",
        &glmnet_binomial_identity_py,
        py::arg("X"),
        py::arg("y"),
        py::arg("n_trials"),
        py::arg("offset"),
  ...
  m.def("glmnet_binomial_correlated",
        &glmnet_binomial_correlated_py,
        py::arg("X"),
        py::arg("y"),
        py::arg("n_trials"),
        py::arg("offset"),
