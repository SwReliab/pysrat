...
static GLMPoissonENetResult glmnet_poisson_identity_py(
...
static GLMPoissonENetResult glmnet_poisson_correlated_py(
    py::array_t<double, py::array::c_style | py::array::forcecast> X,
    py::array_t<double, py::array::c_style | py::array::forcecast> y,
    py::array_t<double, py::array::c_style | py::array::forcecast> offset,
    bool fit_intercept,
...
void bind_glmnet_poisson(py::module_& m) {
  ...
  m.def("glmnet_poisson_identity",
        &glmnet_poisson_identity_py,
        py::arg("X"),
        py::arg("y"),
        py::arg("offset"),
  ...
  m.def("glmnet_poisson_correlated",
        &glmnet_poisson_correlated_py,
        py::arg("X"),
        py::arg("y"),
        py::arg("offset"),
        py::arg("fit_intercept") = true,
